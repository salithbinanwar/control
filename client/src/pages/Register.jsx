...
<div className="registerForm m-10 ">
    <h1 className="max-w-sm mx-auto text-4xl mb-5 ">Admin Register</h1>
    <form className="max-w-sm mx-auto ">
        ...
        <Link className="px-4 py-2 border border-gray-600 rounded-sm shadow-md text-gray-800 font-montserrat text-lg hover:bg-gray-800 hover:text-white transition duration-300" to={"/"}>Register</Link>
        </div>
